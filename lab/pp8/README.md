...
* Deploy a package to the PyPI test index

<https://canvas.harvard.edu/courses/108118/assignments/607994>
...
1. Your private repository should contain a directory named `lab` with
   sub-directories for each session. This session should be named `pp8`.
2. Within the sub-directory `pp8`, place the exercise files that you completed
