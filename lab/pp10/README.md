...
<https://canvas.harvard.edu/courses/108118/assignments/607996>
...
1. Your private repository should contain a directory named `lab` with
   sub-directories for each session. This session should be named `pp10`.
2. Within the sub-directory `pp10`, place the exercise files that you completed
