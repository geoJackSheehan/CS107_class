...
<https://canvas.harvard.edu/courses/108118/assignments/607990>
...
1. Your private repository should contain a directory named `lab` with
   sub-directories for each session. This session should be named `pp4`.
2. Within the sub-directory `pp4`, place the exercise files that you completed
