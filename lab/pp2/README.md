...
<https://canvas.harvard.edu/courses/108118/assignments/607988>
...
1. Your private repository should contain a directory named `lab` with
   sub-directories for each session. This session should be named `pp2`.
2. Within the sub-directory `pp2`, place the exercise files that you completed
