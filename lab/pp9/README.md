...
<https://canvas.harvard.edu/courses/108118/assignments/607995>
...
1. Your private repository should contain a directory named `lab` with
   sub-directories for each session. This session should be named `pp9`.
2. Within the sub-directory `pp9`, place the exercise files that you completed
